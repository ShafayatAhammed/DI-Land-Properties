...
import type { OurLeadershipType as OurLeadership } from "@/lib/types/about-us/types";
import OurLeadershipItem from "@/components/ui/about-us/our-leadership/our-leadership-item";

const OurLeadership: FunctionComponent = (): JSX.Element => {
  const ourLeadership: OurLeadership[] = [
    {
      picSrc: "/staff-1.jpg",
      name: "Rich Wacksman",
