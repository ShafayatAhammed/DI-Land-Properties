...
import type { ActionType as ActionItemProps } from "@/lib/types/contact/types";

const Action: FunctionComponent<ActionItemProps> = ({
  icon,
  title,
  description,
  ...
  return (
    <div className="flex flex-col lg-xl:flex-row bg-blue-2 opacity-[88%] px-10 py-14 items-center gap-2 md:gap-4">
      ...
      <div className="text-white text-center lg-xl:text-start">
        <h5 className="text-xl md:text-2xl xl-2xl:[font-size:27px_!important] font-bold">
          {title}
        </h5>
