...
import type { OurLeadershipType as OurLeadershipItemProps } from "@/lib/types/about-us/types";
import Image from "next/image";
import Link from "next/link";

const OurLeadershipItem: FunctionComponent<OurLeadershipItemProps> = ({
  picSrc,
  name,
  position,
  mobile,
  ...
  lkin,
  email,
}: OurLeadershipItemProps): JSX.Element => {
  return (
...
export default OurLeadershipItem;
