...
import type { HeroFeatListingsPrptRentType as FeatListingsPrptRentItemProps } from "@/lib/types/home/types";
import Link from "next/link";
import Image from "next/image";

const FeatListingsPrptRentItem: FunctionComponent<
  FeatListingsPrptRentItemProps
> = ({
  bannerSrc,
  title,
  beds,
  ...
  listingUrl,
  section,
}: FeatListingsPrptRentItemProps): JSX.Element => {
    ...
    >
      <div className="w-full h-full bg-white rounded-md">
        ...
        <div className="flex flex-col gap-1 p-5 px-2.5 xs:px-5">
          <h5
            className={`text-primary-text text-xl xs:text-[27px] ${
          ...
          <div className="flex justify-between gap-5 items-center">
            <div
              className={`text-[#989AA0] fill-[#989AA0] text-base xs:text-[19px] ${
                section === "carousel" ? "sm-md:text-base" : "md:text-base"
              } xl-2xl:[font-size:20px_!important] flex items-center gap-3`}
            >
              <div className="flex items-center gap-2">
                <span>
                  <svg
                    ...
                    height={28}
                    className={`${
                      section === "carousel" ? "sm-md:w-[21px]" : "md:w-[21px]"
                    } ${
                      section === "carousel" ? "sm-md:h-[21px]" : "md:h-[21px]"
                    } xs:w-[24px] xs:h-[24px] xl-2xl:w-[28px_!important] xl-2xl:h-[28px_!important] w-[22px] h-[22px]`}
                  >
            ...
            <div
              className={`text-xl xs:text-[27px] ${
                section === "carousel" ? "sm-md:text-xl" : "md:text-xl"
...
export default FeatListingsPrptRentItem;
