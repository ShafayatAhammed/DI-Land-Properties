...
const CarouselItem: FunctionComponent<CarouselItemProps> = ({
  ...
  return (
    <Link href={listingUrl} className="select-none inline-block w-full h-full group">
      <div className="w-full h-full bg-white rounded-md">
        ...
        <div className="flex flex-col gap-1 p-5 px-2.5 xs:px-5">
          <h5 className="text-primary-text text-xl xs:text-[27px] sm-md:text-xl xl-2xl:text-2xl group-hover:underline">
            {title.length > 25 ? title.slice(0, 25) + "..." : title}
          </h5>
          <div className="flex justify-between gap-5 items-center">
            <div className="text-[#989AA0] fill-[#989AA0] text-base xs:text-[19px] sm-md:text-base xl-2xl:text-xl flex items-center gap-3">
              <div className="flex items-center gap-2">
                <span>
                  <svg
                    ...
                    width={28}
                    height={28}
                    className="sm-md:w-[21px] sm-md:h-[21px] xs:w-[24px] xs:h-[24px] xl-2xl:w-[28px] xl-2xl:h-[28px] w-[22px] h-[22px]"
                  >
            ...
            <div className="text-xl xs:text-[27px] xl-2xl:text-2xl sm-md:text-xl text-blue-1">
              <p>
