...
const Head: FunctionComponent = (): JSX.Element => {
  return (
    <section className="flex flex-col md:flex-row justify-center md:justify-between gap-4 items-center pb-5 border-b border-gray-500">
      <div className="bg-white p-[2px]">
        <Branding />
      </div>
      <div className="fill-white flex gap-2">
        <Link
          href="https://www.facebook.com"
          className="bg-[#818A91] block p-3 rounded-full hover:bg-blue-2 transition-colors"
        >
          <svg
            ...
            width={25}
            height={25}
            className="w-[20px] h-[20px] xl-2xl:w-[25px] xl-2xl:h-[25px]"
          >
