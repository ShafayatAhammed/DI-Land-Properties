...
import type { GetStartedType } from "@/lib/types/home/types";
import GetStartedItem from "@/components/ui/home/get-started/get-started-item";

const GetStarted: FunctionComponent = (): JSX.Element => {
  const getStartedItems: GetStartedType[] = [
    {
